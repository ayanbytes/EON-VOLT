...
const Facebook = ({ className }: { className?: string }) => (
  <svg className={className} fill="currentColor" viewBox="0 0 24 24"><path fillRule="evenodd" d="M22 12c0-5.523-4.477-10-10-10S2 6.477 2 12c0 4.991 3.657 9.128 8.438 9.878v-6.987h-2.54V12h2.54V9.797c0-2.506 1.492-3.89 3.777-3.89 1.094 0 2.238.195 2.238.195v2.46h-1.26c-1.243 0-1.63.771-1.63 1.562V12h2.773l-.443 2.89h-2.33v6.988C18.343 21.128 22 16.991 22 12z" clipRule="evenodd" /></svg>
);
      ...
      <div className="container mx-auto px-4 sm:px-6 lg:px-8 py-16">
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-5 gap-12">
          ...
          <div>
            ...
            <ul className="space-y-4">
              ...
              <li><Link href="/manufacturing" className="text-background/70 hover:text-primary transition-colors">Manufacturing</Link></li>
              <li><Link href="/sustainability" className="text-background/70 hover:text-primary transition-colors">Sustainability</Link></li>
              <li><Link href="/certifications" className="text-background/70 hover:text-primary transition-colors">Certifications</Link></li>
          ...
          <div>
            ...
            <ul className="space-y-4">
              <li><Link href="/store?category=ev" className="text-background/70 hover:text-primary transition-colors">EV Batteries</Link></li>
              <li><Link href="/store?category=ess" className="text-background/70 hover:text-primary transition-colors">Energy Storage</Link></li>
              <li><Link href="/store?category=industrial" className="text-background/70 hover:text-primary transition-colors">Industrial Batteries</Link></li>
              <li><Link href="/store?category=consumer" className="text-background/70 hover:text-primary transition-colors">Consumer Power</Link></li>
              <li><Link href="/store" className="text-background/70 hover:text-primary transition-colors">All Products</Link></li>
            </ul>
          </div>
          ...
          <div>
            ...
            <ul className="space-y-4">
              <li className="flex items-start gap-3">
                ...
                <span className="text-background/70">123 Industrial Park, Tech Sector 4, CA 90210</span>
              </li>
              ...
              <li className="flex items-center gap-3">
                ...
                <span className="text-background/70">sales@eon-volt.com</span>
              </li>
            </ul>
          </div>
        </div>
        ...
        <div className="mt-16 pt-8 border-t border-background/10 flex flex-col md:flex-row justify-between items-center gap-6">
          ...
          <div className="text-background/50 text-sm">
            © {new Date().getFullYear()} Eon-Volt Technologies. All rights reserved.
          </div>
        </div>
      </div>
    </footer>
